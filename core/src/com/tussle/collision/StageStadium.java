 ...
 */
public strictfp class StageStadium extends StageElement
{
	...
	public StageStadium(double startx, double starty, double endx, double endy, double radius)
	{
		super();
		localx0 = startx; localy0 = starty; localx1 = endx; localy1 = endy; localrad = radius;
	}
	
	public StageStadium(StageStadium base)
	{
		super(base);
	...
	public CollisionStadium getAfterStadium()
	{
		if (aftDirty) computeNewAfterPositions();
		return new CollisionStadium(afterx0, aftery0, afterx1, aftery1, afterrad);
	}

	public CollisionStadium getBeforeStadium()
	{
		if (befDirty) computeNewBeforePositions();
		return new CollisionStadium(beforex0, beforey0, beforex1, beforey1, beforerad);
	}
	...
	public CollisionStadium getStadiumAt(double time)
	{
		return new CollisionStadium(getStartX(time), getStartY(time),
