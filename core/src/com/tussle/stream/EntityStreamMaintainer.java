...
public class EntityStreamMaintainer implements EntityListener
{
	...
	public void entityAdded(Entity entity)
	{
		...
		Components.inputOutputMapper.get(entity).setStdin(readIn);
		//Attach stdout
		PipeBufferWriter writeOut = stdOut.openWriterFor(entity);
		Components.inputOutputMapper.get(entity).setStdout(writeOut);
		//Attach stderr
		PipeBufferWriter writeErr = stdErr.openWriterFor(entity);
		Components.inputOutputMapper.get(entity).setStderr(writeErr);
	}
