...
public class EntitySubactionContext implements ScriptContext
{
	...
	public EntitySubactionContext(Map<Integer, Bindings> init, Reader stdin,
	...
	public void setBindings(Bindings bindings, int scope)
	{
		...
		else if (scope > 0 || !scopeList.contains(scope))
	...
	public void setAttribute(String name, Object value, int scope)
	{
		if (name == null)
			throw new NullPointerException();
		if (name.isEmpty() || scope > 0 || !scopeList.contains(scope))
			throw new IllegalArgumentException();
