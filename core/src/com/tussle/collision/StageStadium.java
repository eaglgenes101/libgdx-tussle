...
public strictfp class StageStadium extends StageElement
{
	                    ...
	                    boolean globalFlipped)
	{
		...
		localx1 = endx; localy1 = endy; localrad = radius;
	                       ...
	                       boolean globalFlipped)
	{
		...
		afterrad = FastMath.abs(localrad * globalScale);
	}
	
	public CollisionStadium getBefore()
	{
		if (hasBefore)
			return new CollisionStadium(beforex0, beforey0,
			                            beforex1, beforey1, beforerad);
		else
			return new CollisionStadium(afterx0, aftery0,
			                            afterx1, aftery1, afterrad);
	}
	
	public CollisionStadium getAfter()
	{
